...
class DelfiSpider(Spider):
    ...
    start_urls = ['http://www.delfi.lt/news/ringas/abroad/m-garbaciauskaite-budriene-tikroji-rusijos-siela-visai-neromantiska.d?id=68404714&com=1&reg=0&s=2&no=' 
	               + str(i) for i in range(0,380,20)]
